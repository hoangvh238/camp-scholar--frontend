...
export const getUserData = (payload:string) => {
  return axiosClient.post(END_POINT.GET_USER+"/"+payload, {
  },
  {
...
export const updateImageUser = (avatar:string,cover:string) => {
  return axiosClient.post(END_POINT.EDIT_PIC, {
    avatarURL : avatar,
    backgroundURL : cover
  },
  {
...
export const updateImageUserPhone = (avatar:string,cover:string,phone:string) => {
  return axiosClient.post(END_POINT.EDIT_PIC, {
    avatarURL : avatar,
    backgroundURL : cover,
    phone: phone
...
export const getCoint = () => {
  return axiosClient.post(END_POINT.GET_COINT, {
  },
  {
    headers: { Authorization: `Bearer ${getCookie("token")}` }, // Sử dụng "Bearer" trước token
  });
...
export const getPoint = () => {
  return axiosClient.post(END_POINT.GET_POINT, {
  },
  {
    headers: { Authorization: `Bearer ${getCookie("token")}` }, // Sử dụng "Bearer" trước token
  });
