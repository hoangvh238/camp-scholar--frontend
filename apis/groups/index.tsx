...
export const createGroup = (payload:CreateGroup) => {
  return axiosClient.post(END_POINT.GROUP_CREATE, {
...
export const updateImageGroup = (payload:UpdateImage,groupID:string) => {
  return axiosClient.put(END_POINT.UPDATE_GROUP+"/"+groupID, {
...
export const getSuggest = () => {
  return axiosClient.post(END_POINT.SUGGEST_GROUP, {
  },{
    headers: { Authorization: `Bearer ${getCookie("token")}` }, // Sử dụng "Bearer" trước token
  });
};
...
export const deleteGroup = (groupID:string) => {
  return axiosClient.post(END_POINT.DELETE_GROUP+"/"+groupID, {
...
export const findGroup = (content:string) => {
  return axiosClient.post(END_POINT.FIND_GROUP, {
    findContent : content
  },  {
    headers: { Authorization: `Bearer ${getCookie("token")}` }, // Sử dụng "Bearer" trước token
  });
...
export const exitGroup = (groupID:number) => {
  return axiosClient.post(END_POINT.EXIT_GROUP+"/"+groupID, {
  }, {
    headers: { Authorization: `Bearer ${getCookie("token")}` }, // Sử dụng "Bearer" trước token
  });
};
...
export const kickMember = (groupID:string,userKick:string) => {
  return axiosClient.post(END_POINT.FIND_GROUP+"/"+groupID+"?userName="+userKick, {
  }, {
    headers: { Authorization: `Bearer ${getCookie("token")}` }, // Sử dụng "Bearer" trước token
  });
};
